...
:root {
  --bg:#0A0E1A; --surface:#111827; --line:#1F2A3D; --txt:#E4E9EF; --dim:#7A8899;
  --vert:#3DD9C4; --rouge:#FF3D3D; --jaune:#FFC400;
}
...
.hdr h1 { font-size:2.1rem; font-weight:800; margin:0; letter-spacing:-0.5px; background:linear-gradient(90deg,#3DD9C4,#5EEAD4); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
...
.stButton > button { background:var(--vert); color:var(--bg); border:none; border-radius:2px; font-family:'Inter',sans-serif !important; font-weight:700; font-size:0.72rem; letter-spacing:2px; text-transform:uppercase; padding:11px 30px; }
